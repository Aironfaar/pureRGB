...
EvosMovesPointerTable:
	...
	dw GoroRaichuEvosMoves ; Aironfaar mod
	dw DratiniEvosMoves
...
; Evolutions
	...
	db EVOLVE_ITEM, MOON_STONE, 1, GORO_RAICHU ; Aironfaar mod
	db 0
; Learnset ; Aironfaar mod: truncated Pikachu's set to branch off into different directions
	db 9, THUNDER_WAVE
	db 12, QUICK_ATTACK
...
;;; Aironfaar mod start: new variant Raichu
GoroRaichuEvosMoves:
; Evolutions
	db 0
; Learnset
...
NidoranFEvosMoves:
; Evolutions
	db EVOLVE_ITEM, MOON_STONE, 1, KAIJU_NIDORINA ; Aironfaar mod
...
; Learnset
	...
	db 18, BITE
	; Aironfaar mod: truncated Nidoran learnsets to allow for variant evolution
	db 0
...
; Learnset
	...
	db 23, STOMP ; Aironfaar mod: give Nidoqueen line a non-TM move (was Body Slam; Nidoking counterpart: Thrash)
	db 26, ACID_ARMOR
	db 31, SLASH
	db 37, DIZZY_PUNCH
	db 43, EARTHQUAKE
...
NidoranMEvosMoves:
; Evolutions
	db EVOLVE_ITEM, MOON_STONE, 1, KAIJU_NIDORINO ; Aironfaar mod
...
; Evolutions
	db 0
; Learnset ; Aironfaar mod: made it more comparable to Vaporeon
	db 6, SHARPEN
	db 10, QUICK_ATTACK
	db 14, ROAR
	db 18, STOMP
	...
	db 35, REFLECT
	db 44, SONICBOOM
	db 49, CONSTRICT ; STATIC SNAG
	db 65, TAKE_DOWN ; HEAT RUSH
	db 65, FOCUS_ENERGY
	db 0
...
; Aironfaar mod: give Winter Dragonair its own learnset to compare with Dragonite
