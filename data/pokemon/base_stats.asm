...
;;; Aironfaar mod start: new variants
...
INCLUDE "data/pokemon/base_stats/stone_venusaur.asm"
INCLUDE "data/pokemon/base_stats/stone_charizard.asm"
INCLUDE "data/pokemon/base_stats/stone_blastoise.asm"
;;; Aironfaar mod end
