;;; Aironfaar mod: new variant mon
	...
	INCBIN "gfx/pokemon/front/kaiju_nidoqueen.pic", 0, 1 ; sprite dimensions
	dw KaijuNidoqueenPicFront, KaijuNidomonarchPicBackSW
	...
	db BANK(KaijuNidomonarchPicBackSW)
