...
MonsterPalettes:
	...
	db PAL_YELLOWMON ; RAICHU ; Aironfaar mod: was PAL_REDMON
	...
	db PAL_BLACKMON   ; MAGNEMITE ; Aironfaar mod: was PAL_GRAYMON
	db PAL_BLACKMON   ; MAGNETON ; Aironfaar mod: was PAL_GRAYMON
	...
	db PAL_BLACKMON   ; ONIX ; Aironfaar mod: was PAL_GRAYMON
