	...
	const_export SAFFRONPOKECENTER_COOLTRAINER_M ; Aironfaar mod
...
SaffronPokecenter_Object:
	...
	object_event 10,  6, SPRITE_COOLTRAINER_M, WALK, LEFT_RIGHT, TEXT_SAFFRONPOKECENTER_COOLTRAINER_M ; Aironfaar mod
