...
;;; Aironfaar mod start: new NPC that allows you to swap your starter for a Dratini until you get the pokedex, evolve it, or otherwise lose Bulbasaur, Charmander or Squirtle
