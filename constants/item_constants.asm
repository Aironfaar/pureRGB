...
;;;;;;;;;; PureRGBnote: MOVED: these constants used to be defined higher up as actual items, they are only used to generate a menu in cerulean city
	...
	const EARTHBADGE    ; $69
;;;;;;;;;;
	const_next $B4 ; Aironfaar mod: added 20 TMs

; HMs are defined before TMs, so the actual number of TM definitions
; is not yet available. The TM quantity is hard-coded here and must
; match the actual number below.
DEF NUM_TMS EQU 70 ; Aironfaar mod
...
; - HM_\1: the item id, starting at $B4
...
MACRO add_tm
; Defines three constants:
; - TM_\1: the item id, starting at $B9
...
; 70 TMs + 5 HMs = 75 learnable TM/HM flags per PKMN.
