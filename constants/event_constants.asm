...
;;; Aironfaar mod start: Fossil Guy "revival service" events, used to be const_skip 3
	const EVENT_FOSSIL_GUY_DOME_SHUTTLE
	const EVENT_FOSSIL_GUY_HELIX_SHUTTLE
	const EVENT_FOSSIL_GUY_AMBER_SHUTTLE
;;; Aironfaar mod end
